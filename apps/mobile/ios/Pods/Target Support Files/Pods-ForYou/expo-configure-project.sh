...
with_node \
  ...
  --target "/Users/a...../china-app/apps/mobile/ios/Pods/Target Support Files/Pods-ForYou/ExpoModulesProvider.swift" \
  --entitlement "/Users/a...../china-app/apps/mobile/ios/ForYou/ForYou.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-router"
